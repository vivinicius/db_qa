...
import Intro from '../data/Cypress/Intro';
import Crud from '../data/Cypress/DesafioCypress';
import CorrecaoCrud from '../data/Cypress/CorrecaoCypress';
    ...
    <div style={{ display: 'flex', flexDirection: 'row', height: '100vh' }}>
      <div className="automacao-sidebar">
        <div className="automacao-sidebar-header">
          <p>
            Conteúdo de <span className="gradient-text">Cypress</span>
          </p>
        </div>
