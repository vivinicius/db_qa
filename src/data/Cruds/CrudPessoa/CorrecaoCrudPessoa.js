...
const CorrecaoCrudPessoaContent = ({ updateExerciseResult }) => {
...
`;
  ...
  const corrigirResposta = async () => {
    ...
    try {
      ...
      const txtPath = process.env.PUBLIC_URL + '/desafio-crud-pessoa.txt';
...
const CorrecaoCrudPessoa = {
  id: 'correcaoCrudPessoa',
  title: 'Correção',
  renderContent: (props) => <CorrecaoCrudPessoaContent {...props} />,
};

export default CorrecaoCrudPessoa;
