...
const CorrecaoSeleniumContent = ({ updateExerciseResult }) => {
...
`;
  ...
  const corrigirResposta = async () => {
    ...
    try {
      ...
      const txtPath = process.env.PUBLIC_URL + '/desafio-selenium.txt';
...
const CorrecaoSelenium = {
  id: 'correcaoSelenium',
  title: 'Correção',
  renderContent: (props) => <CorrecaoSeleniumContent {...props} />,
};

export default CorrecaoSelenium;
