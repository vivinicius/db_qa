...
const CorrecaoSicrediContent = ({ updateExerciseResult }) => {
...
`;
  ...
  const corrigirResposta = async () => {
    ...
    try {
      ...
      const txtPath = process.env.PUBLIC_URL + '/desafio-sicredi.txt';
...
const CorrecaoSicredi = {
  id: 'correcaoSicredi',
  title: 'Correção',
  renderContent: (props) => <CorrecaoSicrediContent {...props} />,
};

export default CorrecaoSicredi;
