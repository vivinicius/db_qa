...
const CorrecaoCypressContent = ({ updateExerciseResult }) => {
...
`;
  ...
  const corrigirResposta = async () => {
    ...
    try {
      ...
      const txtPath = process.env.PUBLIC_URL + '/desafio-cypress.txt';
...
const CorrecaoCypress = {
  id: 'correcaoCypress',
  title: 'Correção',
  renderContent: (props) => <CorrecaoCypressContent {...props} />,
};

export default CorrecaoCypress;
